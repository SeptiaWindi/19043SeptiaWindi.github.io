<h3>Tambah Data Calon Katua Dan Wakil Osis</h3>
<?php
...
if(isset($_POST['tambah_calon'])) {
	...
	if(move_uploaded_file($asal, $direktori)){
		$sql = "INSERT INTO t_calon(calon_no, calon_nama, calon_kelas, calon_foto, calon_visimisi, calon_priode) 
		        VALUES('$calon_no', '$calon_nama', '$calon_kelas', '$nama_file', '$calon_visimisi', '$calon_priode')";

		if(mysqli_query($conn, $sql)) {
			echo "<div class='btn btn-success btn-block'>Data Calon Katua Dan Wakil Osis Berhasil ditambahkan</div>";
		} else {
			echo "<div class='btn btn-danger btn-block'>Data Calon Katua Dan Wakil Osis Gagal ditambahkan</div>";
		}
	} 
}
?>
